...
class NewsController extends Controller
{
    public function index() {
        ...
        return view('pages.admin.event.index', compact('news'));
    }
    ...
    public function edit($id) {
        $news = News::find($id);
        return view('pages.admin.event.edit', compact('news'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            $news->save();
            return Redirect()->route('news.index')->with("success", "Event Update Successfull");
        } catch(\Exception $e) {
            DB::rollback();         
		    // return ["error" => $e->getMessage()];
