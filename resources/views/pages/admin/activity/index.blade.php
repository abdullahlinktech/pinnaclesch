@extends('layouts.admin-master', ['pageName' => 'activity', 'title' => 'Add activity'])
@push('admin-css')
@endpush
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form id="delete-form-{{$item->id}}" action="{{route('activity.delete',$item)}}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
