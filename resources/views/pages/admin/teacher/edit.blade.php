                            ...
                            <form action="{{ route('teacher.update', $teacher) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-9">
                                            <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{ $teacher->name }}" placeholder="teacher name">
                                            @error('name')
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-9">
                                            <input class="form-control @error('phone') is-invalid @enderror" id="phone" type="text" name="phone" value="{{ $teacher->phone }}" placeholder="teacher phone">
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-9">
                                            <input class="form-control @error('designation') is-invalid @enderror" id="designation" type="text" name="designation" value="{{ $teacher->designation }}" placeholder="teacher designation">
                                            @error('designation')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="row my-2">
                                            <div class="col-md-3">
                                                <label for="specality"> Specality <span class="text-danger"> * </span></label>
                                            </div>
                                            <div class="col-md-9">
                                            <input class="form-control @error('specality') is-invalid @enderror" id="specality" type="text" name="specality" value="{{ $teacher->specality }}" placeholder="teacher specality">
                                            @error('specality')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="clearfix mt-1">
                                    <div class="float-md-left">
                                        <a href="{{route('teacher.index')}}" id="prev" class="btn-fill-lg bg-blue-dark btn-hover-yellow">Back</a>
