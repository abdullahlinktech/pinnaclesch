@extends('layouts.admin-master', ['pageName'=> 'dress', 'title' => 'Edit dress'])
                    ...
                    <div class="card-body">
                        <div class="form">
                            <div class="d-flex justify-content-between heading card-header">
                                <h4 class=""><i class="fa fa-edit"></i> Edit Dress Code</h4>
                                <div>
                            ...
                            <form action="{{ route('dress.update', $dress) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-9">
                                            <input class="form-control @error('title') is-invalid @enderror" id="title" type="text" name="title" value="{{ $dress->title }}" placeholder="title">
                                            @error('title')
                                ...
                                <div class="clearfix mt-1">
                                    <div class="float-md-left">
                                        <a href="{{route('dress.index')}}" id="prev" class="btn-fill-lg bg-blue-dark btn-hover-yellow">Back</a>
...
<script>
    ...
    document.getElementById("previewImage").src="{{ asset($dress->image) }}";
</script>
@endpush