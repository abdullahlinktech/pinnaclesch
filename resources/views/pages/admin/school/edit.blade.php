@extends('layouts.admin-master', ['pageName' => 'school', 'title' => 'Edit school'])
                        ...
                        <div class="card-body">
                            <div class="form">
                                <div class="d-flex justify-content-between heading card-header">
                                    <h4 class=""><i class="fa fa-edit"></i> Edit school</h4>
                                    <div>
                                ...
                                <form action="{{ route('school.update', $school) }}" method="POST"
                                    ...
                                    <div class="clearfix mt-1">
                                        <div class="float-md-left">
                                            <a href="{{ route('school.index') }}" id="prev"
