@extends('layouts.admin-master', ['pageName' => 'section', 'title' => 'Add section'])
@push('admin-css')
@endpush
                ...
                <div class="col-md-12">
                    <div class="card height-auto">
                        <div class="d-flex justify-content-between heading card-header">
                            <h4 class=""><i class="fas fa-plus"></i> Add section</h4>
                        </div>
                        <div class="card-body">
                            <div class="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="row my-2">
                                                ...
                                                <div class="col-md-9">
                                                    <select class=" form-control form-control-sm" name="class_id" id="class_id" for="class_id" >
                                                        <option value="" label="-- Select Class type--"></option>
                                            ...
                                            <div class="row my-2">
                                                <div class="col-md-3">
                                                    <label for="title"> Section Name <span class="text-danger"> *
                                                        </span></label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input
                                                        ...
                                                        value="{{ old('title') }}" placeholder=" Section Name">
                                                    @error('title')
                        ...
                        <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->allclass->title }}</td>
                                    <td><img class="border" style="height: 40px; width:50px;" src="{{ asset($item->image) }}" alt=""></td>
                                    <td>
                                        <a href="{{ route('section.edit',$item) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                        <button type="submit" class="btn btn-danger btn-sm" onclick="deletePartner({{ $item->id }})"><i class="fa fa-trash"></i></button>
                                        <form id="delete-form-{{$item->id}}" action="{{route('section.delete',$item)}}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
