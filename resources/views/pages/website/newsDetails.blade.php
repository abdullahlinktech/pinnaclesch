                ...
                <article class="blog-entry">
                    <div class="blog-entry-inner">
                        <div class="entry-meta">
                            <a href="#" class="blog-author"><img src="{{ asset($news->image) }}" alt="" title=""></a>
                            <div class="date">
                                <span> {{ date('d', strtotime($news->date)) }} </span>
                                <p> {{ date('M', strtotime($news->date)) }} <br> {{ date('Y', strtotime($news->date)) }} </p>
                            </div>
                            <a href="#" class="entry_format"><span class="fa fa-picture-o"></span></a>
                        </div>
                        <div class="entry-thumb">
                            <a href="#"><img src="{{ asset($news->image) }}" alt="" title="" class="eventsimg"></a>
                        </div>
